 ...
 */
public class NWSFB06
{
    /**Main method opens FBIN file and stations file and reads information to be computed by
     * NWSFB class, and prints returned information to FBOUT
     */
    ...
    public String getWindTemp(String strAlt)
    {
        ...
        {
            intTem = Integer.parseInt(strAltWea.substring(4, 6));
    ...
    /**
     * gets station ID from weather string
     * @return stret containing the stationID
     */
